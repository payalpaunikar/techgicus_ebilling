...
public class SalePaymentRequest {
    ...
    public SalePaymentRequest(String receiptNo, LocalDate paymentDate, Double amountPaid, PaymentType paymentType, String referenceNumber, String paymentDescription) {
