...
public class SalePaymentResponse {
    ...
    public SalePaymentResponse(Long paymentId, String receiptNo, LocalDate paymentDate, Double amountPaid, PaymentType paymentType, String referenceNumber, String paymentDescription) {
